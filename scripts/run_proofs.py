...
STAGES = [
    ...
    ("decision_frameworks_builder",
     [sys.executable, "scripts/build_decision_frameworks_pack.py", "--self-test"]),
    ("decision_frameworks_checker",
     [sys.executable, "scripts/check_decision_frameworks_pack.py", "--self-test"]),
    ("decision_dag_demo",
     [sys.executable, "scripts/run_decision_dag_demo.py", "--self-test"]),
    ("decision_engine_adversarial_verify",
    ...
    ("contextual_bandit_benchmark",
     [sys.executable, "scripts/run_contextual_bandit_benchmark.py", "--self-test"]),
    ("route_compiler_optimality_benchmark",
     [sys.executable, "scripts/run_route_compiler_benchmark.py", "--self-test", "--trials", "300"]),
    ("repo_inventory",
     [sys.executable, "scripts/repo_inventory.py", "--self-test"]),
    ("backlog_aggregator",
     [sys.executable, "scripts/aggregate_backlog.py", "--self-test"]),
    ("foundry_builder_self_test",
     [sys.executable, "scripts/build_foundry_pack.py", "--self-test"]),
    ("foundry_pack_checker",
     [sys.executable, "scripts/check_foundry_pack.py", "--self-test"]),
    ...
    ("solution_frameworks_checker",
     [sys.executable, "scripts/check_solution_frameworks_pack.py", "--self-test"]),
    ("solve_demo",
     [sys.executable, "scripts/run_solve_demo.py", "--self-test"]),
    ("coding_primitive_builder",
     [sys.executable, "scripts/build_coding_primitive_pack.py", "--self-test"]),
    ("coding_primitive_checker",
     [sys.executable, "scripts/check_coding_primitive_pack.py", "--self-test"]),
    ("coding_primitive_pipeline",
     [sys.executable, "scripts/run_coding_primitive_pipeline.py", "--self-test"]),
    ("unit_tests",
